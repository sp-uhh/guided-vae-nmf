...
from python.models.models import DeepGenerativeModel, Classifier2Classes
...
def main():
    ...
    print('Load models')
    classifier = Classifier2Classes([x_dim, h_dim_cl, y_dim])
    ...
    for i, file_path in enumerate(file_paths):
        ...
        y_hat_hard = (y_hat_soft[:,0] > 0.5).float()
