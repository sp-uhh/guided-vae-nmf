...
def main():
    ...
    for i, file_path in enumerate(file_paths):
        ...
        # Oracle VAD
        y_vad_true = noise_robust_clean_speech_VAD(s_tf,
                                            quantile_fraction_begin=vad_quantile_fraction_begin,
                                            quantile_fraction_end=vad_quantile_fraction_end,
                                            quantile_weight=quantile_weight)
        
        # Transpose to match PyTorch
        y_vad_true = y_vad_true.T # (frames, freq_bins)       
        y_vad_true = torch.tensor(y_vad_true).to(device)
        
        # Compute y_hat_hard x y_vad_true
        y_hat_hard_new = y_hat_hard * y_vad_true
