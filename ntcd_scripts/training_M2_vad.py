...
train_labels = pickle.load(open(os.path.join('data', dataset_size, 'pickle/ntcd_timit/train_vad_labels.p'), 'rb'))
valid_labels = pickle.load(open(os.path.join('data', dataset_size, 'pickle/ntcd_timit/dev_vad_labels.p'), 'rb'))
