...
model_name = 'ntcd_classif_IBM_2classes_normdataset_hdim_{:03d}_{:03d}_end_epoch_{:03d}'.format(h_dim[0], h_dim[1], end_epoch)
...
train_labels = pickle.load(open(os.path.join('data', dataset_size, 'pickle/ntcd_timit/train_noisy_labels.p'), 'rb'))
valid_labels = pickle.load(open(os.path.join('data', dataset_size, 'pickle/ntcd_timit/dev_noisy_labels.p'), 'rb'))
