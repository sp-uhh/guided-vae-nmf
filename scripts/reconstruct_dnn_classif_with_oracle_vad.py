...
def main():
    ...
    for i, file_path in tqdm(enumerate(file_paths)):
        ...
        # Oracle VAD
        y_vad_true = clean_speech_VAD(s_tf,
                                      quantile_fraction=quantile_fraction,
                                      quantile_weight=quantile_weight)
        ...
        # F1-score
        f1score_s_hat = f1_score(s_ibm.flatten(), y_hat_hard_new.flatten(), average="binary")
        ...
        fig.savefig(output_path + '_hard_mask_x_true_vad.png')
